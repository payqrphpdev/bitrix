...
class PayqrConfig
{
    ...
    public static function setConfig()
    {
        ...
        PayqrConfig::$merchantID = $module->getOption("merchant_id");
        PayqrConfig::$secretKeyIn = $module->getOption("secret_key_in");
        PayqrConfig::$secretKeyOut = $module->getOption("secret_key_out");
    }
}